  ...
  return (
    ...
    <Wrapper>
      ...
      <Layout title={"Privacy-Policy-Page"}>
        ...
        {/* This part contains privacy policy information */}
        ...
        <div className="row mt-4">
          ...
          <div className="col-md-11 ml-[60px] mb-[40px] responsive-info">
            ...
            <div>
              ...
              <p className="font-semibold mb-5 text-2xl responsive-paragraphs">
                This website is owned and operated by KeepIt. We recognize that
                visitors to our site may be concerned about the information they
                provide to us and how we treat that information. KeepIt is
              ...
              <p className="font-semibold mb-5 text-2xl responsive-paragraphs">
                ...
                contact us at: The KeepIt, Arengapara Milon Nagar Golaghat Pin-
            ...
            <div>
              ...
              <p className="font-semibold mb-5 text-2xl responsive-paragraphs">
                <h1 className="text-4xl pb-3"> KeepIt </h1>
                KeepIt uses its best efforts to respect the privacy of its
                ...
                our website. KeepIt only gathers personally identifiable data,
                ...
                tax purposes. KeepIt does not sell or trade such information
            ...
            <div>
              ...
              <p className="font-semibold mb-5 text-2xl responsive-paragraphs">
                ...
                may be automatically collected by KeepIt’s website through the
                ...
                deny or accept the cookie feature. keepIt uses cookie technology
            ...
            <div>
              ...
              <p className="font-semibold mb-5 text-2xl responsive-paragraphs">
                ...
                expressly state otherwise, KeepIt makes no representations
                whatsoever concerning the content of those sites. The fact that
                KeepIt has provided a link to a site is not an endorsement,
                ...
                internet, and KeepIt cautions you to make sure that you
                ...
                your computer. Please be aware that KeepIt is not responsible
